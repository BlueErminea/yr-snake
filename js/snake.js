class Snake {
  ...
  move() {
    ...
    var snakeTiles = this.tiles.filter(function (item) {
  ...
  watchKeys() {
    ...
    document.body.addEventListener('keydown', function (ev) {
      ev.preventDefault(); // megakadályozza, h a nyilak a scrollozást okozzák, így csak a játékot irányítja
      switch (ev.keyCode) {
